...
public class DataProvider {
    ...
    public static Map<Integer, List<String>> generateRockAlbumList() {
        ...
        List<String> rockAlbum1= new ArrayList<String>(Arrays.asList("Sgt. Pepper's Lonely Hearts Club Band", "The Beatles", "1967", "39.99",
                "Side 1:<br/>&#8226; Sgt. Pepper's Lonely Hearts Club Band<br/>&#8226; With a Little Help from My Friends<br/>&#8226; Luck in the Sky with Diamonds<br/>&#8226; Getting Better<br/>&#8226; Fixing a Hole<br/>&#8226; She's Leaving Home<br/>&#8226; Being for the Benefit of Mr. Kite!<br/> <br/>Side 2: <br/>&#8226; Within You Without You<br/>&#8226; When I'm Sixty-Four<br/>&#8226; Lovely Rita<br/>&#8226; Good Morning Good Morning<br/>&#8226; St. Pepper's Lonely Hearts Club Band (Reprise)<br/>&#8226; A Day in the Life"));
        List<String> rockAlbum2= new ArrayList<String>(Arrays.asList("Blood On The Tracks", "Bob Dylan", "1975", "32.99",
                "Side 1:<br/>&#8226; Tangled Up in Blue<br/>&#8226; Simple Twist of Fate<br/>&#8226; You're a Big Girl Now<br/>&#8226; Idiot Wind<br/>&#8226; You're Gonna Make Me Lonesome When You Go<br/> <br/>Side 2: <br/>&#8226; Meet Me in the Morning<br/>&#8226; Lily, Rosemary and the Jack of Hearts<br/>&#8226; If You See Her, Say Hello<br/>&#8226; Shelter from the Storm<br/>&#8226; Buckets of Rain"));
        List<String> rockAlbum3= new ArrayList<String>(Arrays.asList("Exile On Main St.", "The Rolling Stones", "1972", "49.99",
                "Disk 1, Side 1:<br/>&#8226; Rocks Off<br/>&#8226; Rip This Joint<br/>&#8226; Shake Your Hips<br/>&#8226; Casino Boogie<br/>&#8226; Tumbling Dice<br/> <br/>Disk 1, Side 2: <br/>&#8226; Sweet Virginia<br/>&#8226; Torn and Frayed<br/>&#8226; Sweet Black Angel<br/>&#8226; Loving Cup<br/> <br/>Disk 2, Side 1: <br/>&#8226; Happy<br/>&#8226; Turd on the Run<br/>&#8226; Ventilator Blues<br/>&#8226; I Just Want to See His Face<br/>&#8226; Let It Loose<br/> <br/>Disk 2, Side 2:  <br/>&#8226; All Down the Line<br/>&#8226; Stop Breaking Down<br/>&#8226; Shine a Light<br/>&#8226; Soul Survivor"));
        List<String> rockAlbum4= new ArrayList<String>(Arrays.asList("Are You Experienced?", "Jimi Hendrix", "1967", "54.99",
                "Side 1:<br/>&#8226; Foxy Lady<br/>&#8226; Manic Depression<br/>&#8226; Red House<br/>&#8226; Can You See Me<br/>&#8226; Love or Confusion<br/>&#8226; I Don't Live Today<br/> <br/>Side 2: <br/>&#8226; May This Be Love<br/>&#8226; Fire<br/>&#8226; 3rd Stone from the Sun<br/>&#8226; Remember<br/>&#8226; Are You Experienced"));
        List<String> rockAlbum5= new ArrayList<String>(Arrays.asList("Born To Run", "Bruce Springsteen", "1975", "26.99",
                "Side 1: <br/>&#8226; Thunder Road<br/>&#8226; Tenth Avenue Freeze-Out<br/>&#8226; Night<br/>&#8226; Backstreets<br/> <br/>Side 2: <br/>&#8226; Born to Run<br/>&#8226; She's the One<br/>&#8226; Meeting Across the River<br/>&#8226; Jungleland"));
        List<String> rockAlbum6= new ArrayList<String>(Arrays.asList("Led Zeppelin IV", "Led Zeppelin", "1971", "31.99",
                "Side 1: <br/>&#8226; Black Dog<br/>&#8226; Rock and Roll<br/>&#8226; The Battle of Evermore<br/>&#8226; Stairway to Heaven<br/> <br/>Side 2: <br/>&#8226; Misty Mountain Hop<br/>&#8226; Four Sticks<br/>&#8226; Going to California<br/>&#8226; When the Levee Breaks"));
        List<String> rockAlbum7= new ArrayList<String>(Arrays.asList("Never Mind The Bollocks, Here's The Sex Pistols", "The Sex Pistols", "1977", "39.99",
                "Side 1: <br/>&#8226; Holidays in the Sun<br/>&#8226; Liar<br/>&#8226; No Feelings<br/>&#8226; God Save the Queen<br/>&#8226; Problems<br/> <br/>Side 2: <br/>&#8226; Seventeen Anarchy in the U.K.<br/>&#8226; Bodies <br/>&#8226; Pretty Vacant<br/>&#8226; New York<br/>&#8226; E.M.I."));
        List<String> rockAlbum8= new ArrayList<String>(Arrays.asList("Who's Next", "The Who", "1971", "29.99",
                "Side 1: <br/>&#8226; Baba O'Riley<br/>&#8226; Bargain<br/>&#8226; Love Ain't for Keeping<br/>&#8226; My Wife<br/>&#8226; The Song Is Over<br/> <br/>Side 2: <br/>&#8226; Getting in Tune<br/>&#8226; Going Mobile<br/>&#8226; Behind Blue Eyes<br/>&#8226; Won't Get Fooled Again"));
        List<String> rockAlbum9= new ArrayList<String>(Arrays.asList("Everybody Knows This is Nowhere", "Neil Young", "1969", "24.99",
                "Side 1: <br/>&#8226; Cinnamon Girl<br/>&#8226; Everybody Knows This Is Nowhere<br/>&#8226; Round & Round (It Won't Be Long)<br/>&#8226; Down by the River<br/> <br/>Side 2: <br/>&#8226; The Losing End (When You're On)<br/>&#8226; Runny Dry (Requiem for the Rockets)<br/>&#8226; CowGirl in the Sand"));
    ...
    public static Map<Integer, List<String>> generatePopAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> popAlbum1= new ArrayList<String>(Arrays.asList("Songs In the Key Of Life", "Stevie Wonder", "1976", "34.99",
        ...
        List<String> popAlbum2= new ArrayList<String>(Arrays.asList("Smile", "The Beach Boys", "1967", "29.99",
        ...
        List<String> popAlbum3= new ArrayList<String>(Arrays.asList("Help!", "The Beatles", "1965", "24.99",
                "Side 1: <br/>&#8226; Help!<br/>&#8226; The Night Before<br/>&#8226; You've Got to Hide Your Love Away<br/>&#8226; I Need You<br/>&#8226; Another Girl<br/>&#8226; You're Going to Lose That Girl<br/>&#8226; Ticket to Ride<br/> <br/>Side 2: <br/>&#8226; Act Naturally<br/>&#8226; It's Only Love<br/>&#8226; You Like Me Too Much<br/>&#8226; Tell Me What You See<br/>&#8226; I've Just Seen a Face<br/>&#8226; Yesterday<br/>&#8226; Dizzy Miss Lizzy"));
        List<String> popAlbum4= new ArrayList<String>(Arrays.asList("The Beat Of My Heart", "Tony Bennett", "1957", "27.99",
                "Side 1: <br/>&#8226; Let's Begin<br/>&#8226; Lullaby of Broadway<br/>&#8226; Let There Be Love<br/>&#8226; Love for Sale<br/>&#8226; Army Air Corps Song<br/>&#8226; Crazy Rhythm<br/> <br/>Side 2: <br/>&#8226; The Beat of My Hear<br/>&#8226; So Beats My Heart For You<br/>&#8226; Blues in the Night<br/>&#8226; Lazy Afternoon<br/>&#8226; Let's Face the Music and Dance<br/>&#8226; Just One of Those Things"));
        List<String> popAlbum5= new ArrayList<String>(Arrays.asList("Private Dancer", "Tina Turner", "1984", "54.99",
                "Side 1: <br/>&#8226; I Might Have Been Queen<br/>&#8226; What's Love Got to Do with It<br/>&#8226; Show Some Respect<br/>&#8226; I Can't Stand the Rain<br/>&#8226; Better Be Good to Me<br/> <br/>Side 2: <br/>&#8226; Let's Stay Together<br/>&#8226; 1984<br/>&#8226; Steel Claw<br/>&#8226; Private Dancer"));
        List<String> popAlbum6= new ArrayList<String>(Arrays.asList("Red", "Taylor Swift", "2012", "49.99",
        ...
        List<String> popAlbum7= new ArrayList<String>(Arrays.asList("Off The Wall", "Michael Jackson", "1979", "23.99",
        ...
        List<String> popAlbum8= new ArrayList<String>(Arrays.asList("Like A Virgin", "Madonna", "1984", "41.99",
        ...
        List<String> popAlbum9= new ArrayList<String>(Arrays.asList("Hunky Dory", "David Bowie", "1971", "13.99",
                "Side 1: <br/>&#8226; Changes<br/>&#8226; Oh! You Pretty Things<br/>&#8226; Eight Line Poem<br/>&#8226; Life on Mars?<br/>&#8226; Kooks<br/>&#8226; Quicksand<br/> <br/>Side 2: <br/>&#8226; Fill Your Heart<br/>&#8226; Andy Warhol<br/>&#8226; Song for Bob Dylan<br/>&#8226; Queen Bitch<br/>&#8226; The Bewlay Brothers"));
    ...
    public static Map<Integer, List<String>> generateMetalAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> metalAlbum1= new ArrayList<String>(Arrays.asList("The Joy Of Motion", "Animals As Leaders", "2014", "31.99",
        ...
        List<String> metalAlbum2= new ArrayList<String>(Arrays.asList("Constellations", "August Burns Red", "2009", "59.99",
        ...
        List<String> metalAlbum3= new ArrayList<String>(Arrays.asList("Toxicity", "System Of A Down", "2001", "32.99",
                "Side 1: <br/>&#8226; Prison Song<br/>&#8226; Needles<br/>&#8226; Deer Dance<br/>&#8226; Jet Pilot<br/>&#8226; X<br/>&#8226; Chop Suey!<br/>&#8226; Bounce<br/>&#8226; Forest<br/> <br/>Side 2: <br/>&#8226; ATWA<br/>&#8226; Science<br/>&#8226; Shimmy<br/>&#8226; Toxicity<br/>&#8226; Psycho<br/>&#8226; Aerials<br/>&#8226; Arto"));
        List<String> metalAlbum4= new ArrayList<String>(Arrays.asList("Back In Black", "AC/DC", "1980", "33.99",
        ...
        List<String> metalAlbum5= new ArrayList<String>(Arrays.asList("Metallica", "Metallica", "1991", "17.99",
        ...
        List<String> metalAlbum6= new ArrayList<String>(Arrays.asList("Killing Machine", "Judas Priest", "1978", "30.99",
        ...
        List<String> metalAlbum7= new ArrayList<String>(Arrays.asList("Hybrid Theory", "Linkin Park", "2000", "28.99",
        ...
        List<String> metalAlbum8= new ArrayList<String>(Arrays.asList("Skipknot", "Skipknot", "1999", "15.99",
        ...
        List<String> metalAlbum9= new ArrayList<String>(Arrays.asList("The Fall Of Ideals", "All That Remains", "2006", "36.99",
    ...
    public static Map<Integer, List<String>> generateElectronicAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> electAlbum1= new ArrayList<String>(Arrays.asList("Discovery", "Daft Punk", "2001", "24.99",
        ...
        List<String> electAlbum2= new ArrayList<String>(Arrays.asList("Floral Shoppe", "Macintosh Plus", "2011", "42.99",
        ...
        List<String> electAlbum3= new ArrayList<String>(Arrays.asList("The North Borders", "Bonobo", "2013", "29.99",
        ...
        List<String> electAlbum4= new ArrayList<String>(Arrays.asList("4x4=12", "Deadmau5", "2010", "31.99",
                "Side 1: <br/>&#8226; SOFI Needs A Ladder<br/>&#8226; A City In Florida<br/>&#8226; Animal Rights<br/>&#8226; Cthulhu Sleeps<br/>&#8226; Some Chords<br/> <br/>Side 2: <br/>&#8226; I Said<br/>&#8226; ad Selection<br/>&#8226; Right This Second<br/>&#8226; Raise Your Weapon<br/>&#8226; One Trick Pony<br/>&#8226; Everything Before"));
        List<String> electAlbum5= new ArrayList<String>(Arrays.asList("Homework", "Daft Punk", "1997", "19.99",
        ...
        List<String> electAlbum6= new ArrayList<String>(Arrays.asList("Midnight In Peckham", "Chaos In The CBD", "2015", "33.99",
                "&#8226; Trust Is Key<br/>&#8226; Observe<br/>&#8226; Midnight In Peckham<br/>&#8226; Luxury Motivation"));
        List<String> electAlbum7= new ArrayList<String>(Arrays.asList("Cross", "Justice", "2007", "29.99",
        ...
        List<String> electAlbum8= new ArrayList<String>(Arrays.asList("Cosmogramma", "Flying Lotus", "2010", "17.99",
        ...
        List<String> electAlbum9= new ArrayList<String>(Arrays.asList("Awake", "Tycho", "2014", "14.99",
    ...
    public static Map<Integer, List<String>> generateHipHopAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> hiphopAlbum1= new ArrayList<String>(Arrays.asList("Midnight Marauders", "A Tribed Called Quest", "1993", "37.99",
        ...
        List<String> hiphopAlbum2= new ArrayList<String>(Arrays.asList("How To Pimp A Butterfly", "Kendrick Lamar", "2015", "24.99",
        ...
        List<String> hiphopAlbum3= new ArrayList<String>(Arrays.asList("Telefone", "Noname", "2016", "29.99",
        ...
        List<String> hiphopAlbum4= new ArrayList<String>(Arrays.asList("Malibu", "Anderson Paak", "2016", "22.99",
        ...
        List<String> hiphopAlbum5= new ArrayList<String>(Arrays.asList("Swimming", "Mac Miller", "2018", "17.99",
        ...
        List<String> hiphopAlbum6= new ArrayList<String>(Arrays.asList("College Dropout", "Kanye West", "2004", "49.99",
                "Side 1: <br/>&#8226; Intro<br/>&#8226; We Don't Care<br/>&#8226; Graduation Day<br/>&#8226; All Falls Down<br/>&#8226; I'll Fly Away<br/>&#8226; Spaceship<br/>&#8226; Jesus Walks<br/>&#8226; Never Let Me Down<br/>&#8226; Get Em High<br/>&#8226; Workout Plan<br/>&#8226; New Workout Plan<br/>&#8226; Slow Jamz<br/>&#8226; Breathe in Breathe Out<br/>&#8226; School Spirit Skit 1<br/>&#8226; School Spirit<br/>&#8226; School Spirit Skit<br/> <br/>Side 2: <br/>&#8226; Lil Jimmy Skit<br/>&#8226; Two Words<br/>&#8226; Through the Wire<br/>&#8226; Family Business<br/>&#8226; Last Call"));
        List<String> hiphopAlbum7= new ArrayList<String>(Arrays.asList("Iridescence", "Brockhampton", "2018", "42.99",
                "Side 1: <br/>&#8226; New Orleans<br/>&#8226; Thug Life<br/>&#8226; Berlin<br/>&#8226; Something About Him<br/>&#8226; Where The Cash At<br/>&#8226; Weight<br/>&#8226; District<br/>&#8226; Loophole<br/>&#8226; Tape<br/> <br/>Side 2: <br/>&#8226; J'Ouvert<br/>&#8226; Honey<br/>&#8226; Vivid<br/>&#8226; San Marcos<br/>&#8226; Tonya<br/>&#8226; Fabric"));
        List<String> hiphopAlbum8= new ArrayList<String>(Arrays.asList("Malibu Ken", "Aesop Rock & TOBACCO", "2019", "27.99",
        ...
        List<String> hiphopAlbum9= new ArrayList<String>(Arrays.asList("2014 Forest Hills Drive", "Cole J", "2014", "29.99",
    ...
    public static Map<Integer, List<String>> generateJazzAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> jazzAlbum1= new ArrayList<String>(Arrays.asList("Kind Of Blue", "Miles Davis", "1959", "37.99",
                "&#8226; So What<br/>&#8226; Freddie Freeloader<br/>&#8226; Blue In Green<br/>&#8226; All Blues<br/>&#8226; Flamenco Sketches"));
        List<String> jazzAlbum2= new ArrayList<String>(Arrays.asList("4", "BADBADNOTGOOD", "2016", "31.99",
        ...
        List<String> jazzAlbum3= new ArrayList<String>(Arrays.asList("Heaven And Earth", "Kamasi Washington", "2018", "24.99",
                "Side 1: <br/>&#8226; Fists of Fury<br/>&#8226; Can You Hear Him<br/>&#8226; Hub-Tones<br/>&#8226; Connections<br/>&#8226; Tiffakonkae<br/>&#8226; The Invincible Youth<br/>&#8226; Testify<br/>&#8226; One of One<br/> <br/>Side 2: <br/>&#8226; The Space Travelers Lullaby<br/>&#8226; Vi Lua Vi Sol<br/>&#8226; Street Fighter Mas<br/>&#8226; Song For The Fallen<br/>&#8226; Journey<br/>&#8226; The Psalmnist<br/>&#8226; Show Us The Way<br/>&#8226; Will You Sing"));
        List<String> jazzAlbum4= new ArrayList<String>(Arrays.asList("Dave Brubeck's Greatest Hits", "Dave Brubeck", "1966", "43.99",
                "Side 1: <br/>&#8226; Take Five<br/>&#8226; I'm In A Dancing Mood<br/>&#8226; In Your Own Sweet Way<br/>&#8226; Camptown Races<br/>&#8226; The Duke<br/> <br/>Side 2: <br/>&#8226; It's A Raggy Waltz<br/>&#8226; Bossa Nova U.S.A.<br/>&#8226; Trolley Song<br/>&#8226; Unsquare Dance<br/>&#8226; Blue Rondo A La Turk<br/>&#8226; Theme From Mr. Broadway"));
        List<String> jazzAlbum5= new ArrayList<String>(Arrays.asList("Head Hunters", "Herbie Hancock", "1973", "32.99",
                "&#8226; Chameleon<br/>&#8226; Watermelon Man<br/>&#8226; Sly<br/>&#8226; Vein Melter"));
        List<String> jazzAlbum6= new ArrayList<String>(Arrays.asList("Animalia", "Mammal Hands", "2014", "59.99",
        ...
        List<String> jazzAlbum7= new ArrayList<String>(Arrays.asList("Fodder On My Wings", "Nina Simone", "1982", "23.99",
                "Side 1: <br/>&#8226; I Sing Just To Know That I'm Alive<br/>&#8226; Fodder In Her Wings<br/>&#8226; Vous êtes seuls, mais je désire être avec vous<br/>&#8226; Il y a un baume à Gilhead<br/>&#8226; Liberian Calypso<br/>&#8226; Alone Again (Naturally)<br/> <br/>Side 2: <br/>&#8226; I Was Just A Stupid Dog To Them<br/>&#8226; Colour Is A Beautiful Thing<br/>&#8226; Le peuple en Suisse<br/>&#8226; Heaven Belongs To You<br/>&#8226; Thandewye<br/>&#8226; Stop<br/>&#8226; They Took My Hand"));
        List<String> jazzAlbum8= new ArrayList<String>(Arrays.asList("Future Shock", "Herbie Hancock", "1983", "34.99",
        ...
        List<String> jazzAlbum9= new ArrayList<String>(Arrays.asList("The Beautiful Game", "Vulfpeck", "2016", "19.99",
                "Side 1: <br/>&#8226; The Sweet Science<br/>&#8226; Animal Spirits<br/>&#8226; Conscious Club<br/>&#8226; El Chepe<br/> <br/>Side 2: <br/>&#8226; 1 For 1, Di Maggio<br/>&#8226; Daddy, He Got A Tesla<br/>&#8226; Aunt Leslie<br/>&#8226; Cory Wong"));
    ...
    public static Map<Integer, List<String>> generateClassicalAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> classicalAlbum1= new ArrayList<String>(Arrays.asList("Bartock: Piano Concertos Nos. 1 & 2", "Chicago Orchestra", "1979", "21.99",
                "&#8226; Piano Concerto No. 1<br/>&#8226; Piano Concerto No. 2"));
        List<String> classicalAlbum2= new ArrayList<String>(Arrays.asList("Pérotin", "Hilliard Ensemble", "1989", "12.99",
        ...
        List<String> classicalAlbum3= new ArrayList<String>(Arrays.asList("The Complete Epic Recordings 1956-66", "Juilliard Quartet", "1980", "17.99",
                "Disk 1, Side 1: <br/>&#8226; String Quartet No. 1 - I – Lento / II – Allegretto<br/>&#8226; String Quartet No. 1 - III – Introduzione: Allegro; Allegro Vivace<br/>&#8226; String Quartet No. 2 - I – Moderato<br/>&#8226; String Quartet No. 2 - II – Allegro Molto Capriccioso<br/>&#8226; String Quartet No. 2 - III – Lento<br/> <br/>Disk 1, Side 2: <br/>&#8226; String Quartet No. 3 - Prima Parte: Moderato<br/>&#8226; String Quartet No. 3 - Seconda Parte: Allegro<br/>&#8226; String Quartet No. 3 - Recapitulazione Della Prima Parte: Moderato<br/>&#8226; String Quartet No. 3 - Coda: Allegro Molto<br/>&#8226; String Quartet No. 4 - I – Allegro<br/>&#8226; String Quartet No. 4 - II – Prestissimo, Con Sordino<br/>&#8226; String Quartet No. 4 - III – Non Troppo Lento<br/>&#8226; String Quartet No. 4 - IV – Allegretto Pizzicato<br/>&#8226; String Quartet No. 4 - V – Allegro Molto<br/> <br/>Disk 2, Side 1: <br/>&#8226; String Quartet No. 5 - I – Allegro<br/>&#8226; String Quartet No. 5 - II – Adagio Molto<br/>&#8226; String Quartet No. 5 - III – Scherzo: Alla Bulgarese<br/>&#8226; String Quartet No. 5 - IV – Andante<br/>&#8226; String Quartet No. 5 - V – Finale: Allegro Vivace<br/>&#8226; String Quartet No. 6 - I – Mesto; Vivace<br/>&#8226; String Quartet No. 6 - II – Mesto; Marcia<br/>&#8226; String Quartet No. 6 - III – Mesto: Burletta: Moderato<br/>&#8226; String Quartet No. 6 - IV – Mesto"));
        List<String> classicalAlbum4= new ArrayList<String>(Arrays.asList("The Piano Sonatas", "András Schiff", "2005", "24.99",
        ...
        List<String> classicalAlbum5= new ArrayList<String>(Arrays.asList("Beethoven: 9 Symphonies", "Herbert von Karajan", "1963", "26.99",
        ...
        List<String> classicalAlbum6= new ArrayList<String>(Arrays.asList("Arvo Pärt", "Estonian Choir", "1994", "13.99",
        ...
        List<String> classicalAlbum9= new ArrayList<String>(Arrays.asList("The Firebird (Fairy-Tale Ballet in Two Tableaux)", "Chicago Orchestra", "1992", "34.99",
