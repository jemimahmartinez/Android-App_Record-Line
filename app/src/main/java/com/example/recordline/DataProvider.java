...
public class DataProvider {
    ...
    public static Map<Integer, List<String>> generateRockAlbumList() {
        ...
        List<String> rockAlbum1= new ArrayList<String>(Arrays.asList("Sgt. Pepper's Lonely Hearts Club Band", "The Beatles", "| 1967", "price",
        ...
        List<String> rockAlbum2= new ArrayList<String>(Arrays.asList("Blood On The Tracks", "Bob Dylan", "| 1975", "price",
        ...
        List<String> rockAlbum3= new ArrayList<String>(Arrays.asList("Exile On Main St.", "The Rolling Stones", "| 1972", "price",
        ...
        List<String> rockAlbum4= new ArrayList<String>(Arrays.asList("Are You Experienced?", "The Jimi Hendrix Experience", "| 1967", "price",
        ...
        List<String> rockAlbum5= new ArrayList<String>(Arrays.asList("Born To Run", "Bruce Springsteen", "| 1975", "price",
        ...
        List<String> rockAlbum6= new ArrayList<String>(Arrays.asList("Led Zeppelin IV", "Led Zeppelin", "| 1971", "price",
        ...
        List<String> rockAlbum7= new ArrayList<String>(Arrays.asList("Never Mind The Bollocks, Here's The Sex Pistols", "The Sex Pistols", "| 1977", "price",
        ...
        List<String> rockAlbum8= new ArrayList<String>(Arrays.asList("Who's Next", "The Who", "| 1971", "price",
        ...
        List<String> rockAlbum9= new ArrayList<String>(Arrays.asList("Everybody Knows This is Nowhere", "Neil Young", "| 1969", "price",
        ...
        List<String> rockAlbum10= new ArrayList<String>(Arrays.asList("The Wall", "Pink FLoyd", "| 1979", "price",
    ...
    public static Map<Integer, List<String>> generatePopAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> popAlbum1= new ArrayList<String>(Arrays.asList("Songs In the Key Of Life", "Stevie Wonder", "| 1976", "price",
        ...
        List<String> popAlbum2= new ArrayList<String>(Arrays.asList("Smile", "The Beach Boys", "| 1967", "price",
        ...
        List<String> popAlbum3= new ArrayList<String>(Arrays.asList("Help!", "The Beatles", "| 1965", "price",
        ...
        List<String> popAlbum4= new ArrayList<String>(Arrays.asList("The Beat Of My Heart", "Tony Bennett", "| 1957", "price",
        ...
        List<String> popAlbum5= new ArrayList<String>(Arrays.asList("Private Dancer", "Tina Turner", "| 1984", "price",
        ...
        List<String> popAlbum6= new ArrayList<String>(Arrays.asList("Red", "Taylor Swift", "| 2012", "price",
        ...
        List<String> popAlbum7= new ArrayList<String>(Arrays.asList("Off The Wall", "Michael Jackson", "| 1979", "price",
        ...
        List<String> popAlbum8= new ArrayList<String>(Arrays.asList("Like A Virgin", "Madonna", "| 1984", "price",
        ...
        List<String> popAlbum9= new ArrayList<String>(Arrays.asList("Hunky Dory", "David Bowie", "| 1971", "price",
        ...
        List<String> popAlbum10= new ArrayList<String>(Arrays.asList("Parallel Lines", "Blondie", "| 1979", "price",
    ...
    public static Map<Integer, List<String>> generateMetalAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> metalAlbum1= new ArrayList<String>(Arrays.asList("The Joy Of Motion", "Animals As Leaders", "| 2014", "price",
        ...
        List<String> metalAlbum2= new ArrayList<String>(Arrays.asList("Constellations", "August Burns Red", "| 2009", "price",
        ...
        List<String> metalAlbum3= new ArrayList<String>(Arrays.asList("Toxicity", "System Of A Down", "| 2001", "price",
        ...
        List<String> metalAlbum4= new ArrayList<String>(Arrays.asList("Back In Black", "AC/DC", "| 1980", "price",
        ...
        List<String> metalAlbum5= new ArrayList<String>(Arrays.asList("Metallica", "Metallica", "| 1991", "price",
        ...
        List<String> metalAlbum6= new ArrayList<String>(Arrays.asList("Killing Machine", "Judas Priest", "| 1978", "price",
        ...
        List<String> metalAlbum7= new ArrayList<String>(Arrays.asList("Hybrid Theory", "Linkin Park", "| 2000", "price",
        ...
        List<String> metalAlbum8= new ArrayList<String>(Arrays.asList("Skipknot", "Skipknot", "| 1999", "price",
        ...
        List<String> metalAlbum9= new ArrayList<String>(Arrays.asList("The Fall Of Ideals", "All That Remains", "| 2006", "price",
        ...
        List<String> metalAlbum10= new ArrayList<String>(Arrays.asList("Rage Against The Machine", "Rage Against The Machine", "| 1991", "price",
    ...
    public static Map<Integer, List<String>> generateElectronicAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> electAlbum1= new ArrayList<String>(Arrays.asList("Discovery", "Daft Punk", "| 2001", "price",
        ...
        List<String> electAlbum2= new ArrayList<String>(Arrays.asList("Floral Shoppe", "Macintosh Plus", "| 2011", "price",
        ...
        List<String> electAlbum3= new ArrayList<String>(Arrays.asList("The North Borders", "Bonobo", "| 2013", "price",
        ...
        List<String> electAlbum4= new ArrayList<String>(Arrays.asList("4x4=12", "Deadmau5", "| 2010", "price",
        ...
        List<String> electAlbum5= new ArrayList<String>(Arrays.asList("Homework", "Daft Punk", "| 1997", "price",
        ...
        List<String> electAlbum6= new ArrayList<String>(Arrays.asList("Midnight In Peckham", "Chaos In The CBD", "| 2015", "price",
                "&#8226; Trust Is Key<br/>&#8226; Observe<br/>&#8226; Midnight In Peckham<br/>&#8226; Luxury Motivation"));
        List<String> electAlbum7= new ArrayList<String>(Arrays.asList("Cross", "Justice", "| 2007", "price",
        ...
        List<String> electAlbum8= new ArrayList<String>(Arrays.asList("Cosmogramma", "Flying Lotus", "| 2010", "price",
        ...
        List<String> electAlbum9= new ArrayList<String>(Arrays.asList("Awake", "Tycho", "| 2014", "price",
                "&#8226; Awake<br/>&#8226; Montana<br/>&#8226; L<br/>&#8226; Dye<br/>&#8226; See<br/>&#8226; Apogee<br/>&#8226; Spectre<br/>&#8226; Plains"));
        List<String> electAlbum10= new ArrayList<String>(Arrays.asList("Alphelion", "Ross From Friends", "| 2018", "price",
    ...
    public static Map<Integer, List<String>> generateHipHopAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> hiphopAlbum1= new ArrayList<String>(Arrays.asList("Midnight Marauders", "A Tribed Called Quest", "| 1993", "price",
        ...
        List<String> hiphopAlbum2= new ArrayList<String>(Arrays.asList("How To Pimp A Butterfly", "Kendrick Lamar", "| 2015", "price",
        ...
        List<String> hiphopAlbum3= new ArrayList<String>(Arrays.asList("Telefone", "Noname", "| 2016", "price",
        ...
        List<String> hiphopAlbum4= new ArrayList<String>(Arrays.asList("Malibu", "Anderson Paak", "| 2016", "price",
        ...
        List<String> hiphopAlbum5= new ArrayList<String>(Arrays.asList("Swimming", "Mac Miller", "| 2018", "price",
        ...
        List<String> hiphopAlbum6= new ArrayList<String>(Arrays.asList("College Dropout", "Kanye West", "| 2004", "price",
        ...
        List<String> hiphopAlbum7= new ArrayList<String>(Arrays.asList("Iridescence", "Brockhampton", "| 2018", "price",
        ...
        List<String> hiphopAlbum8= new ArrayList<String>(Arrays.asList("Malibu Ken", "Aesop Rock & TOBACCO", "| 2019", "price",
        ...
        List<String> hiphopAlbum9= new ArrayList<String>(Arrays.asList("2014 Forest Hills Drive", "Cole J", "| 2014", "price",
        ...
        List<String> hiphopAlbum10= new ArrayList<String>(Arrays.asList("Operation Doomsday", "Mf Doom", "| 1999", "price",
                "&#8226; The Time We Faced Doom<br/>&#8226; Doomsday<br/>&#8226; Rhymes Like Dimes (Feat. DJ Cucumber Slice)<br/>&#8226; The Finest (Feat. Tommy Gunn)<br/>&#8226; Back in the Days<br/>&#8226; Go with the Flow<br/>&#8226; Tick Tock (Feat. MF Grimm)<br/>&#8226; Red & Gold<br/>&#8226; The Hands of Doom<br/> <br/>&#8226; Doom, Are You Awake<br/>&#8226; Hey<br/>&#8226; Operation Greenbacks(Feat. Megalon & King Geedorah)<br/>&#8226; The Mic<br/>&#8226; The Mystery of Doom<br/>&#8226; Dead Bent<br/>&#8226; Gas Drawls<br/>&#8226; Question Mark (Feat. Kurious Jorge)<br/>&#8226; Hero Vs Villain"));
    ...
    public static Map<Integer, List<String>> generateJazzAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> jazzAlbum1= new ArrayList<String>(Arrays.asList("Kind Of Blue", "Miles Davis", "| 1959", "price",
                "&#8226; So What<br/>&#8226; Freddie Freeloader<br/>&#8226; Blue In Green<br/>&#8226; All Blues<br/>&#8226; Flamenco Sketches"));
        List<String> jazzAlbum2= new ArrayList<String>(Arrays.asList("4", "BADBADNOTGOOD", "| 2016", "price",
        ...
        List<String> jazzAlbum3= new ArrayList<String>(Arrays.asList("Heaven And Earth", "Kamasi Washington", "| 2018", "price",
        ...
        List<String> jazzAlbum4= new ArrayList<String>(Arrays.asList("Dave Brubeck's Greatest Hits", "Dave Brubeck", "| 1966", "price",
        ...
        List<String> jazzAlbum5= new ArrayList<String>(Arrays.asList("Head Hunters", "Herbie Hancock", "| 1973", "price",
                "&#8226; Chameleon<br/>&#8226; Watermelon Man<br/>&#8226; Sly<br/>&#8226; Vein Melter"));
        List<String> jazzAlbum6= new ArrayList<String>(Arrays.asList("Animalia", "Mammal Hands", "| 2014", "price",
        ...
        List<String> jazzAlbum7= new ArrayList<String>(Arrays.asList("Fodder On My Wings", "Nina Simone", "| 1982", "price",
        ...
        List<String> jazzAlbum8= new ArrayList<String>(Arrays.asList("Future Shock", "Herbie Hancock", "| 1983", "price",
                "&#8226; Rockit<br/>&#8226; Future Shock<br/>&#8226; TFS<br/>&#8226; Earth Beat<br/>&#8226; Autodrive<br/>&#8226; Rough"));
        List<String> jazzAlbum9= new ArrayList<String>(Arrays.asList("The Beautiful Game", "Vulfpeck", "| 2016", "price",
        ...
        List<String> jazzAlbum10= new ArrayList<String>(Arrays.asList("Songs In The Key Of Life", "Stevie Wonder", "| 1976", "price",
                "&#8226; Love's in Need of Love Today<br/>&#8226; Have a Talk with God<br/>&#8226; Village Ghetto Land<br/>&#8226; Contusion<br/>&#8226; Sir Duke<br/> <br/>&#8226; I Wish<br/>&#8226; Knocks Me Off My Feet<br/>&#8226; Pastime Paradise<br/>&#8226; Summer Soft<br/>&#8226; Ordinary Pain<br/> <br/>&#8226; Isn't She Lovely<br/>&#8226; Joy Inside My Tears<br/>&#8226; Black Man<br/> <br/>&#8226; Ngiculela - Es Una Historia - I Am Singing<br/>&#8226; If It's Magic<br/>&#8226; As<br/>&#8226; Another Star"));
    ...
    public static Map<Integer, List<String>> generateClassicalAlbumList() {
        Map<Integer, List<String>> albums =
                new LinkedHashMap<Integer, List<String>>();
        List<String> classicalAlbum1= new ArrayList<String>(Arrays.asList("Bartock: Piano Concertos Nos. 1 & 2", "Chicago Symphony Orchestra & Béla Bartók", "| 1979", "price",
                "&#8226; Piano Concerto No. 1<br/>&#8226; Piano Concerto No. 2"));
        List<String> classicalAlbum2= new ArrayList<String>(Arrays.asList("Pérotin", "The Hilliard Ensemble", "| 1989", "price",
        ...
        List<String> classicalAlbum3= new ArrayList<String>(Arrays.asList("The Complete Epic Recordings 1956-66", "Bartók, Juilliard String Quartet & The Six String Quartets", "| 1980", "price",
        ...
        List<String> classicalAlbum4= new ArrayList<String>(Arrays.asList("The Piano Sonatas", "András Schiff & Ludwig van Beethoven", "| 2005", "price",
        ...
        List<String> classicalAlbum5= new ArrayList<String>(Arrays.asList("Beethoven: 9 Symphonies", "Herbert von Karajan & Berliner Philharmoniker", "| 1963", "price",
        ...
        List<String> classicalAlbum6= new ArrayList<String>(Arrays.asList("Arvo Pärt", "Estonian Philharmonic Chamber Choir, Tallinn Chamber Orchestra & Tõnu Kaljuste", "| 1994", "price",
        ...
        List<String> classicalAlbum7= new ArrayList<String>(Arrays.asList("Beethoven: The Late String Quartets", "Takács Quartet", "| 2004", "price",
        ...
        List<String> classicalAlbum8= new ArrayList<String>(Arrays.asList("Officium", "Jan Garbarek & The Hilliard Ensemble", "| 1994", "price",
        ...
        List<String> classicalAlbum9= new ArrayList<String>(Arrays.asList("The Firebird (Fairy-Tale Ballet in Two Tableaux), Igor Stravinsky", "Chicago Symphony Orchestra & Pierre Boulez", "| 1992", "price",
        ...
        List<String> classicalAlbum10= new ArrayList<String>(Arrays.asList("Different Trains/Electric Counterpoint", "Steve Reich", "| 1989", "price",
